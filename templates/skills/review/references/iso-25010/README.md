...
ソフトウェア品質特性の参照リソース。9 特性 × 39 副特性 を網羅 (ISO/IEC 25010:2023 公式 + 業界実務で重要な拡張観点を一部含む)。`km:review` Phase 3 の 3 レビュアが担当分を Read するほか、人間が一般知識として学習する用途にも使う。
...
| レビュア | 担当特性 | 視点 |
|---|---|---|
| architect | 2, 3, 7, 8 | 長期・横断・非機能 (不可逆 × 波及大) |
| security | 6, 9 | 脅威モデル・攻撃面 |
| adversary | 1, 4, 5 | 境界・異常系・信頼性 (敵対的批判) |
